            ...
            <div class="container">
                <div class="axil-dashboard-warp">
                    <div class="axil-dashboard-author">
                        <div class="media">
                            <div class="thumbnail">
                                <img src="${contextPath}/images/${sessionScope.picture}" alt="Hello">
                            </div>
                            <div class="media-body">
                                <h5 class="title mb-0">Xin chào ${sessionScope.fullname}</h5>
                            ...
                            <aside class="axil-dashboard-aside">
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" href="${contextPath}/logout"><i class="fal fa-sign-out"></i>Đăng xuất</a>
                                    </div>
                                </nav>
                            </aside>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                    <div class="axil-dashboard-overview">
                                        <div class="welcome-text">Xin chào ${sessionScope.fullname} (không phải <span>${sessionScope.fullname}?</span> <a href="${contextPath}/logout">Đăng xuất</a>)</div>
