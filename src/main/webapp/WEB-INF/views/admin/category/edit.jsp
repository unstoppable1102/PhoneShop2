...
<div
	...
	<div class="container mx-auto">
		...
		<f:form action="update" method="post" modelAttribute="category" enctype="multipart/form-data">
									...
									<div>
										<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4">
											<div class="group relative rounded border p-2 flex">
												<img class="rounded max-h-[140px] max-w-full" src="${contextPath}/images/${category.image}" id="preview">
