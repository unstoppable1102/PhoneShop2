								...
								<tr>
									...
									<td>
										<div class="flex items-center">
											<span class="ml-2 rtl:mr-2 font-semibold">${c.name}</span>
										</div>
									</td>
									<td>
										<c:choose>
									...
									<td><img src="${contextPath}/images/${c.image}" width="100"/></td>
									<td>
										<div class="flex justify-end text-lg">
											<a class="cursor-pointer p-2 hover:text-indigo-600"
												href="${contextPath}/admin/category/edit?id=${c.id}">
												...
												href="${contextPath}/admin/category/delete?id=${c.id}">
												<svg stroke="currentColor" fill="none" stroke-width="2"
													viewBox="0 0 24 24" aria-hidden="true" height="1em"
													width="1em" xmlns="http://www.w3.org/2000/svg">
                                                <path
