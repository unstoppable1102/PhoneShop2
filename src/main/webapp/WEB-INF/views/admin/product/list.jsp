							...
							<tr>
								...
								<td>
									<div class="flex items-center">
										<span class="avatar avatar-rounded avatar-md"> 
											<img class="avatar-img avatar-rounded" src="${contextPath}/images/${p.picture}">
										</span>
								...
								<td>
									<div class="flex justify-end text-lg">
										<a class="cursor-pointer p-2 hover:text-indigo-600" href="${contextPath}/admin/product/edit?id=${p.productId}">
										...
										<a class="cursor-pointer p-2 hover:text-red-500" href="${contextPath}/admin/product/delete?id=${p.productId}" > <svg
						    ...
						    <c:forEach var="i" begin="1" end="${totalpage}">
						    	<c:choose>
						    		<c:when test="${i==currentpage}">
						    			<li class="pagination-pager active">
						    				<a class="page-link" href="${contextPath}/admin/product/list?pageno=${i}">${i}</a>
						    			</li>
						    		</c:when>
						    		<c:otherwise>
						    			<li class="pagination-pager active">
