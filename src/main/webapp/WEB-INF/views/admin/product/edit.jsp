...
<div
	...
	<div class="container mx-auto">
		...
		<f:form action="update" method="post" enctype="multipart/form-data" modelAttribute="product">
							...
							<div class="card-body">
								...
								<div class="form-item vertical">
									<label class="form-label mb-2">Product Id</label>
									 <div>
										<f:hidden class="input" path="productId"/>
										<label class="form-label mb-2">${product.productId}</label>
									</div> 
								</div>
								<div class="form-item vertical">
										...
										<div
											...
											<div class="group relative rounded border p-2 flex">
												<img class="rounded max-h-[140px] max-w-full"
													src="${contextPath}/images/${product.picture}" alt="image-1" id="preview">
											...
											<div class="upload upload-draggable hover:border-primary-600 min-h-fit">
												<input class="upload-input draggable" type="file" onchange="showImg(this, 'preview')">
