		...
		<div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 mb-6">
							 	...
							 	<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true"
									height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                  	<path fill-rule="evenodd" clip-rule="evenodd"
										d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z"></path>
                             	</svg>
							</span>
							<span>17.2%</span>
						</div>
			...
			<div class="card card-border">
				<div class="card-body">
					<div class="flex justify-between items-center">
						<div class="flex items-center gap-4">
							<span class="avatar avatar-rounded !bg-blue-500 text-2xl"
								data-avatar-size="55"> 
								<span class="avatar-icon">
									<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true" height="1em"
										width="1em" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="card card-border" role="presentation">
				<div class="card-body">
					<div class="flex justify-between items-center">
						<div class="flex items-center gap-4">
							<span class="avatar avatar-rounded !bg-emerald-500 text-2xl"
								data-avatar-size="55"> 
								<span class="avatar-icon">
									<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true" height="1em"
										width="1em" xmlns="http://www.w3.org/2000/svg">
							...
							<td>${a.username}</td>
								<td>
									<div class="flex items-center">
										...
										<img class="avatar-img avatar-circle" src="${contextPath}/images/${a.picture}" loading="lazy">
										</span> 
										<a class="hover:text-primary-600 ml-2 rtl:mr-2 font-semibold" href="">${a.fullName}</a>
									</div>
								</td>
								<td>${a.email}</td>
								<td><c:choose>
										<c:when test="${a.status == true}">
											<div class="flex items-center gap-2">
												<span class="badge-dot bg-emerald-500"></span> <span
													class="capitalize font-semibold text-emerald-500">Active</span>
											</div>
										</c:when>
										<c:otherwise>
											<div class="flex items-center gap-2">
												<span class="badge-dot bg-red-500"></span> <span
													class="capitalize font-semibold text-red-500">Lock</span>
											</div>
										</c:otherwise>
									</c:choose></td>
								<td>
									<a href="${contextPath}/admin/customer/edit/${a.id}" class="text-primary-600 cursor-pointer select-none font-semibold">Edit</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
