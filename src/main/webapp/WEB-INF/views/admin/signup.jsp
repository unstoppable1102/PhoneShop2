...
<!-- Mirrored from www.themenate.net/elstar-html/signup-side.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 02:19:53 GMT -->
<head>
		<meta charset="UTF-8" />
                        ...
                        <div class="page-container relative h-full flex flex-auto flex-col">
                            <div class="grid lg:grid-cols-3 h-full">
                                <div class="bg-no-repeat bg-cover py-6 px-16 flex-col justify-between hidden lg:flex" style="background-image: url('img/others/auth-side-bg.jpg');">
                                    <div class="logo">
                                        <img src="${contextPath}/admin/img/logo/logo-dark-full.png" alt="Elstar logo">
                                    </div>
                                    <div>
                                            ...
                                            <form action="#">
                                                <div class="form-container vertical">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        ...
                                                        <a class="text-primary-600 hover:underline" href="signin-side.html">Sign In</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
