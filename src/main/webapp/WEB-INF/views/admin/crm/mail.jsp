                      ...
                      <div class="h-full mail-list-scroll relative">
                              ...
                              <div class="bg-gray-50 dark:bg-gray-700 w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-1.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-2.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-3.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-4.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-5.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-6.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-7.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-8.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-9.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                          ...
                          <div class="mail-item relative flex border-b border-gray-200 dark:border-gray-600 last:border-0 hover:bg-hover">
                              <div class=" w-full py-6 pr-4 pl-5 cursor-pointer select-none hover:bg-gray-50 hover:dark:bg-gray-700 flex">
                                  <div class="ltr:mr-2 rtl:ml-2">
                                      <span class="avatar avatar-circle" data-avatar-size="25">
                                          <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-10.jpg" loading="lazy">
                                      </span>
                                  </div>
                                  <div class="w-full">
                                      <div class="flex items-center justify-between mb-2">
                                  ...
                                  <div class="card card-border">
                                      <div class="card-body">
                                          <div class="md:flex items-center justify-between">
                                              <div class="flex items-center">
                                                  <span class="avatar avatar-circle avatar-md">
                                                      <img class="avatar-img avatar-circle" src="${contextPath}/admin/img/avatars/thumb-16.jpg" loading="lazy">
                                                  </span>
                                                  <div class="ltr:ml-2 rtl:mr-2">
